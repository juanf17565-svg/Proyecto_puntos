...
|---|---|---|---|---|
| `id` | INT PK | No | AUTO | Identificador único |
| `invitador_id` | INT FK → usuarios | No | — | El cliente dueño del código. Puede invitar a muchos (puede repetirse) |
...
| `longitud_codigo_invitacion` | `8` | Longitud del código de invitación generado automáticamente |
...
3. INSERT INTO canjes (estado='pendiente', puntos_usados=snapshot)
4. INSERT INTO movimientos_puntos (tipo='canje_producto', puntos=-X)
5. UPDATE usuarios SET puntos_saldo = puntos_saldo - X
```
